        ...
        <div class="row">
            <div class="col-xs-12 col-md-9 content">
								<div id="primary">
									...
									<p><?php echo __("Je bijdrage zal pas gepubliceerd worden nadat de beheerder het item goedkeurt voor publicatie. Voeg in tussentijd gerust nog meer items toe.</a>"); ?>
									</p>

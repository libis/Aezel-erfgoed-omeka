    ...
    <?php if(current_user() && $user->id == current_user()->id || is_allowed('UserProfiles_Profile', 'edit')):  ?>
        <section class="three columns omega">
            <div id='save' class='panel'>
                <a class="big button" href="<?php echo url('user-profiles/profiles/edit/id/' . $user->id . '/type/' . $userprofilestype->id); ?>"><?php echo __('Pas profiel aan' ,$userprofilestype->label); ?></a>
            </div>
        </section>
    <?php endif; ?>
    </div>
